...
#pragma GCC diagnostic pop
  ...
  default:
	...
	// ARGHH!!!:
	// Denne kode tager h�jde for tilf�lde som fx loadfen K1r1Q1q1///////7k w - -
	// check_if_moved will v�re true for Q, da der vil
	// v�re en skakkende brik p� denne linje.
	// loadfen 4Q1q1/K1r5//////7k w - -
	// DI... = DI... n�dvendigg�res af fx loadfen K2Qq/2n//////k w - -
...
// hvis en bonde forfremmes til en dronning samtidig med at den sl�r en brik
// g�r der vist rod i nummereringen

...
Move Search_3::calculate_move(ostream& os) {
  ...
  // Last search is presumeable outdated by 2 ply
...
bool Search_3::clr_search(void *ignored, Board *board, ostream& os, vector<string> &p) {
...
inline AlphaBetaInfo Search_3::info_after_move(AlphaBetaInfo info, Move move) {
...
inline void Search_3::beta_cutoff(int extended_ply, int depth, AlphaBetaValue value) {
...
inline void Search_3::update_tt_at_leaf(int depth, int value, int eval_type) {
...
inline AlphaBetaValue Search_3::alpha_beta_move(int ply, int depth, int alpha, int beta,
